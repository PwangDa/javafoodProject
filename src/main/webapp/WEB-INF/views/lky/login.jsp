					...
					<div class="table1">
					    ...
					    <form method="post" action="/login">
					        <div class="head1">
				            	...
				            	<span class ="chec" style= "margin-left :10px; font-size:13px;">
				            		<a href="/searchID" style="color: rgb(141, 141, 141);">아이디 찾기 /</a>
			            		</span>
				            	<span class ="chec">
<<<<<<< HEAD
				            		<a href="/searchPW" style="font-size:10px; color: rgb(141, 141, 141);">비밀번호 찾기</a>
=======
				            		<a href="/pwFindForm_ok" style="font-size:13px; color: rgb(141, 141, 141);">비밀번호 찾기</a>
>>>>>>> 26f9a9aa27c0b39b9391d38cbf6c1b9811d3b551
			            		</span>
...
<a href="/kakaopay.html">
	<img class="img_pay" src="https://t1.daumcdn.net/cfile/tistory/991DCC4A5D089DC501">
</a>
<a href="/kakaopay.html"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
