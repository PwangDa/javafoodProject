...
<div class="table">
				<div>
					...
					<c:if test="${not empty login}">
						<div class="table1">
							<p>아이디는 <span style="color:rgb(79, 117, 255); font-weight: bold; font-size: 20px; margin:10px;">${login[0].ID}</span> 입니다</p>							
						 </div>
						 <br>
						 <br>
					...
					<c:if test="${empty login}">
						<div class="table1">
							<span style="font-weight: bold;">아이디가 없습니다.</span>
						</div>
						<br>
						<br>
						<a href="/searchID" style="margin-right: 190px;">다시찾기</a>
